...
#        self.instruction_lookup[0xFB] = instructions.EI(pc_state)
    ...
    def _populate_extended_ed_instruction_map(self, clocks, pc_state, memory, ports):
        ...
        self.instruction_ed_lookup[0x42] = instructions.SBC_HL_r16(pc_state, self._reg_wrapper_bc)
        ...
        self.instruction_ed_lookup[0x5A] = instructions.ADC_HL_r16(pc_state, self._reg_wrapper_de)
        ...
        self.instruction_ed_lookup[0x62] = instructions.SBC_HL_r16(pc_state, self._reg_wrapper_hl)
        self.instruction_ed_lookup[0x63] = instructions.LD_nn_HL(pc_state)
        self.instruction_ed_lookup[0x67] = instructions.RRD(pc_state)
        self.instruction_ed_lookup[0x6A] = instructions.ADC_HL_r16(pc_state, self._reg_wrapper_hl)
        self.instruction_ed_lookup[0x6B] = instructions.LD_HL_nn(pc_state)
        self.instruction_ed_lookup[0x72] = instructions.SBC_HL_r16(pc_state, self._reg_wrapper_sp)
        self.instruction_ed_lookup[0x73] = instructions.LD_nn_SP(pc_state)
        self.instruction_ed_lookup[0x7A] = instructions.ADC_HL_r16(pc_state, self._reg_wrapper_sp)
